...
public class DailyActivityDetailServiceTest {
    ...
    public void testGetAllDailyActivityDetailByDate() {
        ...
        List<DailyActivityDetail> response1 = dailyActivityDetailService.getAllDailyActivityDetailByDate("20220101");
        ...
        List<DailyActivityDetail> response2 = dailyActivityDetailService.getAllDailyActivityDetailByDate("20220102");
        assertEquals(details2, response2);
    }

    @Test
    public void testGetAllDailyActivityDetailByDate_WhenDateDoesNotExist() {
        List<DailyActivityDetail> details = dailyActivityDetailService.getAllDailyActivityDetailByDate("20220103");
    ...
    public void testGetAllDailyActivityDetailByCategory() {
        ...
        List<DailyActivityDetail> response1 = dailyActivityDetailService.getAllDailyActivityDetailByCategory("walking");
        assertEquals(details1, response1);
        ...
        List<DailyActivityDetail> response2 = dailyActivityDetailService.getAllDailyActivityDetailByCategory("running");
        assertEquals(details2, response2);
    }

    @Test
    public void testGetAllDailyActivityDetailByCategory_WhenCategoryDoesNotExist() {
        List<DailyActivityDetail> details = dailyActivityDetailService.getAllDailyActivityDetailByCategory("swimming");
        assertNotNull(details);
        assertTrue(details.isEmpty());
    }
