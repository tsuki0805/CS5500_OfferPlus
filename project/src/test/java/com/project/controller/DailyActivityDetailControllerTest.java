...
public class DailyActivityDetailControllerTest {
    ...
    public void testFetchAllDailyActivityDetailByDate() {
        List<DailyActivityDetail> details1 = Arrays.asList(
                ...
                new DailyActivityDetail("10002", "cycling", 200,
                        ...
                        "20220101T132707-0800", "20220101T132847-10800",
                        80));
        when(dailyActivityDetailService.getAllDailyActivityDetailByDate("20220101")).thenReturn(details1);
        ResponseEntity<List<DailyActivityDetail>> response1 = dailyActivityDetailController.fetchAllDailyActivityDetailByDate("20220101");
        ...
        List<DailyActivityDetail> details2 = Arrays.asList(
                ...
                new DailyActivityDetail("10004", "running", 155,
                        ...
                        "20220102T132707-0800", "20220102T132847-1010",
                        160));
        when(dailyActivityDetailService.getAllDailyActivityDetailByDate("20220102")).thenReturn(details2);
        ResponseEntity<List<DailyActivityDetail>> response2 = dailyActivityDetailController.fetchAllDailyActivityDetailByDate("20220102");
    ...
    public void testGetAllDailyActivityDetailByDate_WhenDateDoesNotExist() {
        ResponseEntity<List<DailyActivityDetail>> response = dailyActivityDetailController.fetchAllDailyActivityDetailByDate("20220103");
    ...
    public void testFetchAllDailyActivityDetailByCategory() {
        List<DailyActivityDetail> details1 = Arrays.asList(
                ...
                new DailyActivityDetail("10003", "walking", 123,
                        ...
                        "20220102T132707-0800", "20220102T132847-1010",
                        140));
        when(dailyActivityDetailService.getAllDailyActivityDetailByCategory("walking")).thenReturn(details1);
        ResponseEntity<List<DailyActivityDetail>> response1 = dailyActivityDetailController.fetchAllDailyActivityDetailByCategory("walking");
        assertEquals(HttpStatus.OK, response1.getStatusCode());
        assertEquals(details1, response1.getBody());
        ...
        List<DailyActivityDetail> details2 = List.of(
                new DailyActivityDetail("10004", "running", 155,
                        ...
                        "20220102T132707-0800", "20220102T132847-1010",
                        160));
        when(dailyActivityDetailService.getAllDailyActivityDetailByCategory("running")).thenReturn(details2);
        ResponseEntity<List<DailyActivityDetail>> response2 = dailyActivityDetailController.fetchAllDailyActivityDetailByCategory("running");
        assertEquals(HttpStatus.OK, response2.getStatusCode());
        assertEquals(details2, response2.getBody());
    }
    ...
    public void testGetAllDailyActivityDetailByCategory_WhenCategoryDoesNotExist() {
        ResponseEntity<List<DailyActivityDetail>> response = dailyActivityDetailController.fetchAllDailyActivityDetailByCategory("swimming");
        assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
        assertNull(response.getBody());
    }
}
